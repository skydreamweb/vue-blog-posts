...
const performSearch = async (value: any) => {
    const fetchUsers = fetch('https://jsonplaceholder.typicode.com/users')
        ...
        .then((response) => {
            ...
            const filteredUsers = response.filter(user => user.name.toLowerCase().includes(value.toLowerCase()) || user.username.toLowerCase().includes(value.toLowerCase()) || user.email.toLowerCase().includes(value.toLowerCase()))
...
const chunkPosts = postStore.getChunk() as Post[]
